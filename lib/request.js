...
module.exports = (options) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        // PATCH START
        if (options.timeout) {
            // Timeout handler for socket timeout, which can happen
            // before DNS lookup, socket connection, and read/write.
            ...
            if (options.agent) {
                // options.timeout is overwritten by agent.
                // So overwrite it again.
                request.once('socket', (socket) => {
